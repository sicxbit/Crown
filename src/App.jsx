    ...
    <div className="font-sans text-gray-800 w-full overflow-x-hidden">
      ...
      <header className="bg-white shadow-md sticky top-0 z-50">
        <div className="flex justify-between items-center py-4 px-4">
          <h1 className="text-2xl font-bold text-blue-600">Crown Caregivers <span className="inline sm:inline md:inline lg:inline xl:inline 2xl:inline block max-[453px]:block">
            {" "}
            Inc.
          </span></h1>
        ...
        {menuOpen && (
          <div className="md:hidden px-4 pb-4">
            ...
            <a href="#services" className="block py-2 hover:text-blue-600">Services</a>
